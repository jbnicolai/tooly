...
function b(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a}var c,d=/\s+/,e=/\s([a-z]+)/i,f=Array.prototype.slice,g=function(){/*!
   ...
   * @see  tooly#each
   */
function b(a,b,c){if(null!=a){if(q&&a.forEach===q)a.forEach(b,c);else{var d=0,e=a.length;if(e===+e)for(;e>d;d++)b.call(c,a[d],d,a);else{var f=Object.keys(a);for(e=f.length;e>d;d++)b.call(c,a[f[d]],f[d],a)}}return a}}function e(a){return[].map.call(a,function(a){return a})}function h(a){return a.sort().filter(function(b,c){return!c||b!=a[c-1]})}function i(a){return r[a]||(r[a]=new RegExp("\\s*"+a+"\\s*(![\\w\\W])?","g")),r[a]}function j(a,b,c){var e=a.className.split(d);return e.some(function(a){return a.match(c)==b})}function k(a,b){if(!a.className)return void(a.className+=b?" "+b:"");var c=a.className;a.className+=" "+b.split(d).filter(function(a){return-1===c.indexOf(a)}).join(" ")}function l(b,c,d){function f(a){a.insertAdjacentHTML(b?"beforeend":"afterbegin",h)}var h,i=n(c);if(a(d,"string"))h=d;else{var j=a(d);if(h=m(d)?d.outerHTML:d instanceof g.Frankie?d.els:"array"===j?d:"nodelist"===j?e(d):null,a(h,"array"))h=h.map(function(a){return a.outerHTML}).join("");else if(!h)return g}return m(i)?f(i):a(i,"array")&&i.forEach(f),g}function m(a){return a&&(1===a.nodeType||9===a.nodeType)}function n(b){return b instanceof g.Frankie?b.els:a(b,"string")?g.selectAll(b):a(b,"nodelist")?e(b):b}var o,p,q=Array.prototype.forEach,r={},s=/{(\d+)}/g;return{select:function(b,c){var d;return c&&(d=n(c),a(d,"array")&&(d=d[0])),(m(d)?d:document).querySelector(b)},selectAll:function(b,c){var d;return c&&(d=n(c),a(d,"array")&&(d=d[0])),e((m(d)?d:document).querySelectorAll(b))},parent:function(b){var c=n(b);return m(c)?c.parentNode:a(c,"array")?h(c.map(function(a){return a.parentNode})):void 0},children:function(b){var c=n(b);return m(c)?c.children:a(c,"array")?c.map(function(a){return a.children}):void 0},hasClass:function(b,c){var d=n(b);if(m(d))return j(d,c,i(c));if(a(d,"array")){var e=i(c);return d.some(function(a,b,d){return j(d[b],c,e)})}return!1},addClass:function(b,c){var d=n(b);return m(d)?k(d,c):a(d,"array")&&d.forEach(function(a){k(a,c)}),g},removeClass:function(b,c){function e(a){a.className=a.className.replace(i(c)," ").trim()}var f=n(b);return c="("+c.split(d).join("|")+")",m(f)?e(f):a(f,"array")&&f.forEach(e),g},prepend:function(a,b){return l(!1,a,b)},append:function(a,b){return l(!0,a,b)},empty:function(b){function c(a){for(;a.lastChild;)a.removeChild(a.lastChild)}var d=n(b);return a(d,"array")?d.forEach(c):c(d),g},html:function(b,c){if(1===arguments.length)return"array"===a(b)&&m(b[0])?b[0].innerHTML:m(b)?b.innerHTML:g.select(b).innerHTML;if(!m(b)){if("array"===a(b)){for(var d=0,e=b.length;e>d;d++)m(b[d])?b[d].innerHTML=c:(b[d]=g.select(b[d]),b[d].innerHTML=c);return g}return g.select(b).innerHTML=c,g}return b.innerHTML=c,g},css:function(){var b=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a.style[c]=b[c])},c=n(arguments[0]),d=arguments.length,e={},f=!0;if(d>1&&(3===d?e[arguments[1]]=arguments[2]:e=arguments[1]),e){if(m(c))return b(c,e),g;if(a(c,"array"))return f=!1,c.forEach(function(a){b(a,e)}),g}return f?c.style:c[0].style||void 0},attr:function(){var b,c,d=n(arguments[0]),e=arguments.length,f=a(d,"array");if(!f&&!m(d)||1>=e||e>3)return null;if(c=arguments[1],2===e){if(!a(c,"object"))return b=(f?d[0]:d).getAttribute(c),""===b?null:b;for(var h in c)c.hasOwnProperty(h)&&(f?d.forEach(function(a){a.setAttribute(h,c[h])}):d.setAttribute(h,c[h]))}else if(f){var i=arguments[2];d.forEach(function(a){a.setAttribute(c,i)})}else d.setAttribute(c,arguments[2]);return g},Frankie:function(a,b){return this instanceof g.Frankie?(this.els=m(a)?[a]:g.selectAll(a,b),this):new g.Frankie(a,b)},scale:function(a,b,c,d,e){return(a-b)*(e-d)/(c-b)+d},construct:function(b,c){function d(){return"array"===a(c)?b.apply(this,c):b.call(this,c)}return d.prototype=b.prototype,new d},basicExtend:function(a,b){return _basicExtend(a,b)},extend:function(){var b,c,d,e,f,h,i=arguments[0]||{},j=1,k=arguments.length,l=!1;for(a(i,"boolean")&&(l=i,i=arguments[1]||{},j=2),a(i,"object")||a(i,"function")||(i={});k>j;j++)if(b=arguments[j],null!=b){a(b,"string")&&(b=b.split(""));for(c in b)d=i[c],e=b[c],i!==e&&(l&&e&&(g.isHash(e)||(f=a(e,"array")))?(f?(f=!1,h=d&&a(d,"array")?d:[]):h=d&&g.isHash(d)?d:{},i[c]=g.extend(l,h,e)):"undefined"!=typeof e&&(i[c]=e))}return i},fromPrototype:function(a,b){var c,d=Object.create(a);for(c in b)b.hasOwnProperty(c)&&(d[c]=b[c]);return d},inherit:function(a,b,c){b.prototype=new a,b.prototype.constructor=b;for(var d in c)c.hasOwnProperty(d)&&(b.prototype[d]=c[d])},isHash:function(b){return"object"===a(b)&&b.constructor===Object&&!b.nodeType&&!b.setInterval},toType:function(b,c){return a(b,c)},/*! @alias for #toType */
